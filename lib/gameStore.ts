...
export const LEVELS = [
  { id: 1, name: "組み立てよう！",  desc: "3Dプリンターのパーツを正しく配置", color: "#CE93D8" },
  { id: 2, name: "データを準備！",  desc: "3Dモデルをベッドに正しくセット",   color: "#64B5F6" },
  { id: 3, name: "スライス設定",    desc: "品質・強度・速度のバランスを調整",  color: "#80DEEA" },
  { id: 4, name: "プリント開始！",  desc: "積層プロセスをアニメーションで体験", color: "#A5D6A7" },
  { id: 5, name: "トラブル対応！",  desc: "よくある失敗の対処法をクイズで学ぶ", color: "#FFCC80" },
];
